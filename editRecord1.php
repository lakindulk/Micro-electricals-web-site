...
//attempt insert query execution
 $sql = "UPDATE `ledproduct` SET `id`='$id',`watt`='$watt',`company`='$company',`date`='$date',`phone`='$phone',`price`='$price' WHERE id = '$id'";	
...
<br/><br/>
	...
	watt
    <input type="text" name="watt" value = "<?php echo $watt ?>" /><br/><br/>
