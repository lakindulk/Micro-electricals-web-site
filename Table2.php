...
<head>
<title>ADD highwatt PRODUCTS</title>
	...
	<?php
		...
		if($result->num_rows>0)
		{
				...
				while($row=$result->fetch_assoc())
				{
					...
					echo "<td><button type= 'submit' class='button'><a href='editRecord2.php?id=$id'>Edit</a></button></td>";
					echo "<td><button type='submit' class='button button3'><a href='Delete2.php?id=$id'>Delete</a></button></td></tr>";
